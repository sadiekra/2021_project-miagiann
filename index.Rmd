...
```{r, fig.width = 6, fig.height = 3, fig.cap="Map of tree data", as.is = TRUE}
map <- leaflet() %>%
  addTiles(group = "CartoDB")%>%
  addCircleMarkers(data = tree_pop_data, lng = tree_pop_data$longitude, lat = tree_pop_data$latitude, radius = 0.0001)
```
